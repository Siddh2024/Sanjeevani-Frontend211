  ...
  return (
    <div className="w-full max-w-[340px] md:max-w-[420px] aspect-square flex items-center justify-center">
      <svg viewBox="0 0 400 400" className="w-full h-full">
        ...
        />
        <OrbitingElectron
          rx={160} ry={55} rotation={10} duration={5}
          sphereGradient="url(#electronSphere)" r={10}
        />
        ...
        />
        <OrbitingElectron
          rx={160} ry={55} rotation={70} duration={5} direction={-1}
          sphereGradient="url(#electronSphere)" r={10}
        />
        ...
        />
        <OrbitingElectron
          rx={160} ry={55} rotation={-50} duration={5}
          sphereGradient="url(#electronSphere)" r={10}
        />
        ...
        />
        <circle cx="200" cy="200" r="30" fill="url(#electronSphere)" />
      </svg>
    </div>
  );
}
...
export function ResearchPaperVector({ isDark }: { isDark: boolean }) {
  const purpleAccent = isDark ? '#c4b5fd' : '#8b5cf6';
  ...
  return (
    <div className="w-full max-w-[340px] md:max-w-[420px] aspect-square flex items-center justify-center relative">
      <svg viewBox="0 0 400 400" className="w-full h-full">
        <rect
          x="75" y="45" width="250" height="310" rx="10"
          fill="none" stroke={primaryStroke} strokeWidth="1.2"
        />

        <line
          x1="105" y1="45" x2="105" y2="355"
          stroke={tertiaryStroke} strokeWidth="0.8" strokeDasharray="2 3"
        />

        <motion.line
          x1="120" y1="80" x2="280" y2="80"
          stroke={primaryStroke} strokeWidth="4" strokeLinecap="round"
        ...
        <motion.line
          x1="120" y1="105" x2="210" y2="105"
          stroke={secondaryStroke} strokeWidth="2.5" strokeLinecap="round"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        <motion.line
          x1="120" y1="135" x2="295" y2="135"
          stroke={tertiaryStroke} strokeWidth="1.5" strokeLinecap="round"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ delay: 1.0, duration: 0.5, ease: 'easeInOut' }}
        />
        <motion.line
          x1="120" y1="155" x2="260" y2="155"
          stroke={tertiaryStroke} strokeWidth="1.5" strokeLinecap="round"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        <motion.path
          ...
          fill="none" stroke={primaryStroke} strokeWidth="1.5" strokeLinejoin="round"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        <motion.path
          ...
          stroke={primaryStroke} strokeWidth="1"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
        ...
        <motion.path
          ...
          fill="none" stroke={purpleAccent} strokeWidth="1.2"
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          transition={{ delay: 3.8, duration: 0.3 }}
        />
        <motion.circle
          cx="255" cy="223" r="3" fill={purpleAccent}
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        />
        <motion.circle
          cx="145" cy="223" r="3" fill={purpleAccent}
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ delay: 4.1, duration: 0.2 }}
        />
  ...
  return (
    <div className="w-full max-w-[340px] md:max-w-[420px] aspect-square flex items-center justify-center relative">
      <svg viewBox="0 0 400 400" className="w-full h-full">
        ...
        <text
          x="200" y="74" textAnchor="middle"
          fontSize="9" fontWeight="bold" fill={primaryStroke}
        ...
        <g opacity={0.8}>
          <path
            ...
            fill="none" stroke={secondaryStroke} strokeWidth="1.8"
          />
          <path
          ...
          />
          <motion.circle
            cx="200" cy="120" r="3" fill={purpleAccent}
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <path
            ...
            fill="none" stroke={secondaryStroke} strokeWidth="1.2"
          />
        ...
        >
          <line
            x1="80" y1="57" x2="320" y2="57"
            stroke={primaryStroke} strokeWidth="1.2" opacity={0.9}
        ...
        >
          <circle
            cx="200" cy="198" r="20"
            fill="none" stroke={purpleAccent} strokeWidth="1.8"
          />
          <motion.path
            d="M 190 198 L 197 205 L 210 188"
            fill="none" stroke={purpleAccent}
